...
function updateThemeIcon() {
 ...
 button.setAttribute("aria-label",currentTheme === "dark" ? "Aktifkan mode terang" : "Aktifkan mode gelap");
...
hamburger.setAttribute('aria-controls','navLinks');hamburger.setAttribute('aria-expanded','false');hamburger.setAttribute('aria-label','Open atau tutup navigasi');
...
(function(){
  var btn=document.getElementById('switchToIndonesian');
  if(btn){
